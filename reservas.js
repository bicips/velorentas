...
function renderTL(){
  ...
  // Reservas confirmadas sin bici asignada
  ...
  var sinAsignar=reservas.filter(function(r){
    ...
    // Si tiene tipo/talla filtrado, solo las de ese tipo+talla
    if(tipo&&r.lineas){
    ...
    // No tiene ninguna bici asignada
  ...
  if(sinAsignar.length){
    ...
    html+='<div class="tl-row"><div class="tl-bc"><div class="tl-bn" style="color:#b45309">⚠️ Sin asignar</div><div class="tl-bm" style="color:#b45309">'+sinAsignar.length+' reserva'+(sinAsignar.length!==1?'s':'')+'</div></div><div class="tl-cells">';
