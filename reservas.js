...
function bikeFreeForRange(bikeId,ini,fin,excludeId){var ok=true;reservas.forEach(function(r){if(r.bikeId!==bikeId||ESTADOS_LIBRE_GLOBAL.indexOf(r.estado)>=0||(excludeId&&r.id===excludeId))return;
  // FIX: respeta los días de preparación fijados manualmente en el timeline (r.prepDias) para ESTA reserva.
  // Antes r.prepDias solo se dibujaba en el timeline pero nunca afectaba al cálculo real de disponibilidad.
